...
11. 'FitnessTracker' - Track fitness activities with 'Activity Type', 'Duration'.
12. 'AppointmentScheduler' - Schedule appointments with 'Date', 'Time', 'Purpose'.
13. 'LearningAssistant' - Provide educational content with 'Subject', 'Grade Level'.
13. 'VoiceControl' - Control devices with 'Device Name', 'Action'.
14. 'EmergencyAlert' - Send emergency alerts with 'Type of Emergency', 'Location'.
15. 'TravelPlanner' - Plan trips with 'Destination', 'Departure Date', 'Budget'.
16. 'PetCare' - Provide pet care advice with 'Pet Type', 'Issue'.
17. 'EventReminder' - Remind about events with 'Event Name', 'Event Date'.
18. 'LanguageLearning' - Assist in language learning with 'Language', 'Proficiency Level'.
19. 'MoodTracker' - Track mood with 'Current Mood', 'Time of Day'.
20. 'ProductFinder' - Help find products with 'Product Name', 'Category'.
21. 'Horoscope' - Provide horoscope with 'Zodiac Sign'.
22. 'BookRecommendations' - Suggest books with 'Genre', 'Author'.
23. 'HomeworkHelper' - Assist with homework with 'Subject', 'Complexity Level'.
24. 'GardeningTips' - Offer gardening advice with 'Plant Type', 'Season'.
25. 'PublicTransportInfo' - Provide transport information with 'Transport Mode', 'Route'.
26. 'StockMarketUpdates' - Give stock updates with 'Stock Symbol', 'Market'.
27. 'PersonalFinance' - Offer finance advice with 'Finance Topic', 'Experience Level'.
28. 'Time' - Provide the current time.
29. 'TakePicture' - Take a picture with the webcam.
30. 'VoiceControl' - Control devices with 'Device Name', 'Action'.
31. 'GeminiModule' - Sends to gemini to get answers from GEMINI AI
...
time_up_message_path = r"C:\Users\prave\Downloads\cassical-piano-beethoven-215973.mp3"
...
def main():
    ...
    engine.say("Hey  ,I am your ai parrot. How can I assist you today?")
    engine.runAndWait()
    ...
    while True:
        ...
        if "thank you" in user_input.lower():
            engine.say("it's my pleasure master")
            engine.runAndWait()
            continue
        ...
        if "good evening" in user_input.lower():
            engine.say("Hello, good evening,Your evening should be fun and relaxing. . ...")
            engine.runAndWait()
            continue
